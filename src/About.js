        ...
        <div className='md:grid md:grid-cols-2 h-full'>
            <div className='w-full h-full bg-brown py-28 flex justify-center'>
                <div className='w-11/12 md:w-11/12 lg:w-4/5 flex flex-col items-center'>
                    ...
                    <p className='sm:w-4/5 md:w-full lg:w-4/5 text-gray text-center font-mono tracking-tighter text-lg'> As an engineer I'm mainly building projects with React, Redux and Node, but I love learning and am happy to identify and apply creative technical solutions to the task at hand. I'm interested in design, creating meaningful user experiences and delivering high quality code.</p>
                </div>
            </div>
